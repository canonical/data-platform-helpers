...
class KafkaCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(self.on.sync_bootstrap_server_action, self._on_sync_bootstrap_server)
        self.framework.observe(self.kafka_provider.on.mtls_cert_updated, self._on_mtls_cert_updated)
