...
class ApplicationCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(self.on.get_credentials_action, self._on_get_credentials_action_etcd)
        ...
        self.framework.observe(self.on.delete_relation_field_action, self._on_delete_relation_field)
